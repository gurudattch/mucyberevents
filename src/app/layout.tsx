...
export const metadata: Metadata = {
  ...
  keywords: ["Cyber Security Week", "Mandsaur University", "CTF", "Cybersecurity", "Hackathon", "Ethical Hacking", "Workshop"],
  authors: [{ name: "Mandsaur University" }],
  icons: {
    icon: "/images/event-logo.png",
  },
  openGraph: {
    title: "Cyber Security Week 2025 | Mandsaur University",
    description: "A week-long cybersecurity event featuring CTF, workshops, expert talks, and more at Mandsaur University, Mandsaur.",
    type: "website",
  },
  twitter: {
