  ...
  return (
    <div className="glass-card rounded-xl overflow-hidden border border-[#1e293b]/50 hover:border-[#00ff41]/20 transition-all">
      ...
      >
        ...
        <ChevronDown
          className={`w-5 h-5 text-[#00ff41] flex-shrink-0 transition-transform duration-300 ${
            isOpen ? "rotate-180" : ""
          }`}
        />
      </button>
      ...
      >
        <div className="px-5 pb-5 text-sm text-[#94a3b8] leading-relaxed border-t border-[#1e293b]/50 pt-4">
          {answer}
        </div>
      </motion.div>
    </div>
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-block px-3 py-1 rounded-full border border-[#00d4ff]/30 bg-[#00d4ff]/10 mb-4">
            <span className="text-[#00d4ff] text-xs font-mono uppercase tracking-wider">Got Questions?</span>
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
            <span className="text-white">FAQ</span>
          </h2>
          <p className="text-[#94a3b8]">
            Find answers to commonly asked questions about the event
          </p>
        </motion.div>
        ...
        >
          <div className="glass-card rounded-xl p-6 border border-[#00d4ff]/10">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-[#00d4ff]/10 border border-[#00d4ff]/20 text-[#00d4ff] font-mono text-sm hover:bg-[#00d4ff]/20 transition-all"
            >
              csw@mandsauruniversity.edu.in
            </a>
          </div>
        </motion.div>
      </div>
